...
- Consulting Topic: 
    - Explore the differences between similar schools in terms of demographics and programs offered
    - Explore how those differences contribute to school competitiveness 
  
## Analysis Workflow and Components | Data cleaning and EDA

  - Select the related variables
  - Deal with NA values
  - Transform variables as needed
  - Obtain descriptive statistics, summaries and plots of all the related variables

## Analysis Workflow and Components | Method
...
## Analysis Workflow and Components | Analysis
