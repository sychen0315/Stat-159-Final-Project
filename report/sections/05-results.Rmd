...
1. For every 1% increase in median earning 10 years after graduation, we expect the number of students applied to  increase by `r round(summary(ols_full_log_fit)$coefficients[2, 1], 2)`%, holding other variables constant.
...
3. If the 4-year completion rate goes up by 1%, the number of students applied is predicted to increase by `r round(summary(ols_full_log_fit)$coefficients[4, 1], 2)`%, holding other variables constant.
